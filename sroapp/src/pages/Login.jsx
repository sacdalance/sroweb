...
const Login = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-100">
            {/* Hero */}
            <div className="flex flex-col items-center justify-center gap-4 px-4 pt-16 pb-4 md:py-4 min-h-[100dvh]">
                ...
                <button
                    ...
                    className="cursor-pointer flex flex-col items-center gap-1 text-sro-primary hover:text-sro-primary/80 transition-colors"
                >
